...
public class Util {
  ...
  public static boolean hasProfileFolder(DataDistributionManager distributionManager, Session session, String username) throws RepositoryException, Exception {
      ...
      try {
          distributionManager.getDataDistributionType(DataDistributionMode.OPTIMIZED).getDataNode(getProfilesFolder(session), username);
      } catch (PathNotFoundException exception) {
          return false;
      }
      return true;
  ...
  public static boolean hasMembershipFolder(DataDistributionManager distributionManager, Session session, Membership membership) throws RepositoryException, Exception {
      ...
      try {
          ...
          distributionManager.getDataDistributionType(DataDistributionMode.OPTIMIZED).getDataNode(getMembershipsFolder(session), dataId);
      } catch (PathNotFoundException exception) {
          return false;
      }
      return true;
  ...
  public static boolean hasGroupFolder(DataDistributionManager distributionManager, Session session, String groupId) throws RepositoryException, Exception {
      ...
      try {
          distributionManager.getDataDistributionType(DataDistributionMode.OPTIMIZED).getDataNode(getGroupsFolder(session), getGroupFolderName(groupId));
      } catch (PathNotFoundException exception) {
          return false;
      }
      return true;
  ...
  public static void createUserFolder(DataDistributionManager distributionManager, Session session, String username) throws Exception {
    ...
    public static void createProfileFolder(DataDistributionManager distributionManager, Session session, String username) throws Exception {
        ...
        distributionManager.getDataDistributionType(DataDistributionMode.OPTIMIZED).getOrCreateDataNode(getProfilesFolder(session), username);
    }
    ...
    public static void createMembershipFolder(DataDistributionManager distributionManager, Session session, Membership membership) throws Exception {
        String dataId = getMembershipFolderName(membership);
        distributionManager.getDataDistributionType(DataDistributionMode.OPTIMIZED).getOrCreateDataNode(getMembershipsFolder(session), dataId);
  ...
  public static void createGroupFolder(DataDistributionManager distributionManager, Session session, String groupId) throws Exception {
      ...
      Node groupNode = distributionManager.getDataDistributionType(DataDistributionMode.OPTIMIZED).getOrCreateDataNode(groupsNode, getGroupFolderName(groupId));
  ...
  public static Node getUserNode(DataDistributionManager distributionManager, Session session, String username) throws Exception {
      ...
      return distributionManager.getDataDistributionType(DataDistributionMode.OPTIMIZED).getDataNode(getUsersFolder(session), username);
  }
  ...
  public static Node getGroupNode(DataDistributionManager distributionManager, Session session, String groupId) throws Exception {
      ...
      return distributionManager.getDataDistributionType(DataDistributionMode.OPTIMIZED).getDataNode(getGroupsFolder(session),getGroupFolderName(groupId));
  }
  ...
  public static void deleteProfileFolder(DataDistributionManager distributionManager, Session session, String username) throws Exception {
      ...
      distributionManager.getDataDistributionType(DataDistributionMode.OPTIMIZED).removeDataNode(getProfilesFolder(session), username);
  }
  ...
  public static void deleteGroupFolder(DataDistributionManager distributionManager, Session session, String groupId) throws Exception {
      ...
      saveListActivation(groupsNode, groups, false);
      distributionManager.getDataDistributionType(DataDistributionMode.OPTIMIZED).removeDataNode(groupsNode, getGroupFolderName(groupId));
  ...
  public static void deleteMembershipFolder(DataDistributionManager distributionManager, Session session, Membership membership) throws Exception {
      ...
      String dataId = getMembershipFolderName(membership);
      distributionManager.getDataDistributionType(DataDistributionMode.OPTIMIZED).removeDataNode(getMembershipsFolder(session), dataId);
      String membershipId = computeMembershipId(membership);
