...
import org.exoplatform.services.parser.html.MoveType;
import org.exoplatform.services.parser.html.Name;
import org.exoplatform.services.parser.html.NodeConfig;
import org.exoplatform.services.parser.html.NodeConfigs;
import org.exoplatform.services.parser.html.Tag;
import org.exoplatform.services.parser.html.Group.Block;
import org.exoplatform.services.parser.html.Group.Default;
import org.exoplatform.services.parser.html.Group.Flow;
import org.exoplatform.services.parser.html.Group.Fontstyle;
import org.exoplatform.services.parser.html.Group.Formctrl;
import org.exoplatform.services.parser.html.Group.HeadContent;
import org.exoplatform.services.parser.html.Group.HeadMisc;
import org.exoplatform.services.parser.html.Group.Heading;
import org.exoplatform.services.parser.html.Group.HtmlContent;
import org.exoplatform.services.parser.html.Group.List;
import org.exoplatform.services.parser.html.Group.Phrase;
import org.exoplatform.services.parser.html.Group.Preformatted;
import org.exoplatform.services.parser.html.Group.Special;
import org.exoplatform.services.parser.html.Group.Table;
...
public class HTML {
  ...
  private static NodeConfig [] configs;
  ...
  static public NodeConfig getConfig(Name key) {    
    ...
    while (low <= high) {
      int mid = (low + high) >> 1;
      NodeConfig config = configs[mid];
      int cmp = config.name().compareTo(key); 
  
      if (cmp < 0) low = mid + 1;
      else if (cmp > 0) high = mid - 1;
      else return configs[mid]; 
    }
    return null;  
  }
  ...
  static boolean isChild(HTMLNode parent, NodeConfig config){
    ...
    NodeImpl node = new NodeImpl(config.name().toString().toCharArray(), config, TypeToken.TAG);
