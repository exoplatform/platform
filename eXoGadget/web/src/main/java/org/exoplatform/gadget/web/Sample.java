...
public class Sample extends GadgetApplication<UIGadget> {
  ...
  public String getApplicationId() { return "eXoGadgetWeb/Sample"; }

  public String getApplicationName() { return "Sample"; }

  public String getApplicationGroup() { return "eXoGadgetWeb"; }
  ...
  public void processRender(UIGadget uiGadget, Writer w) throws Exception {
    ...
    String script = 
      "eXo.portal.UIPortal.createJSApplication('eXo.gadgets.web.sample.Sample','Sample" + instanceId + "','"+instanceId+"','/eXoGadgetWeb/javascript/');";
