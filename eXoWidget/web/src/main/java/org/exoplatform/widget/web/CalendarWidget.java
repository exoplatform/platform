 ...
 * Nov 16, 2007  
 */
public class CalendarWidget extends WidgetApplication<UIWidget> {
  public String getApplicationId() { return "eXoWidgetWeb/CalendarWidget"; }

  public String getApplicationName() { return "CalendarWidget"; }
  ...
  public void processRender(UIWidget uiWidget, Writer w) throws Exception {
    ...
    w.write("<div id = 'UICalendarWidget' applicationId = '"+instanceId+"' posX = '"+posX+"' posY = '"+posY+"' zIndex = '"+zIndex+"'><span></span></div>") ;
    
    String script = 
      "eXo.portal.UIPortal.createJSApplication('eXo.widget.web.calendar.UICalendarWidget','UICalendarWidget','"+instanceId+"','/eXoWidgetWeb/javascript/');";
