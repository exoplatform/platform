...
@NamedQueries({ @NamedQuery(name = "loginHistory.getLastLogins", query = "SELECT l FROM LoginHistoryEntity l ORDER BY l.id DESC"),
    @NamedQuery(name = "loginHistory.getLastLoggedUsers", query = "SELECT DISTINCT l.userId FROM LoginHistoryEntity l"),
