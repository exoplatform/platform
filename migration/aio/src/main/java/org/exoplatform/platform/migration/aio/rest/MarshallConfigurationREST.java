...
@URITemplate(MarshallConfigurationService.CLASS_URI_TEMPLE)
public class MarshallConfigurationREST implements ResourceContainer {
  ...
  @HTTPMethod("GET")
  @URITemplate(MarshallConfigurationService.GET_CONTAINERS_METHOD_URI_TEMPLE)
  @OutputTransformer(StringOutputTransformer.class)
  ...
  @HTTPMethod("GET")
  @URITemplate(MarshallConfigurationService.GET_COMPONENT_METHOD_URI_TEMPLE)
  ...
  @HTTPMethod("GET")
  @URITemplate(MarshallConfigurationService.GET_CONTAINER_CONFIGURATION_URI_TEMPLE)
  @OutputTransformer(PassthroughOutputTransformer.class)
