...
public class DatabaseJcrWizardView extends WizardView {
  ...
  public DatabaseJcrWizardView(SetupWizardController controller, int stepNumber, SetupWizardMode mode) {
