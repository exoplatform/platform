...
public class MailSettingWizardView extends WizardView {
  ...
  public MailSettingWizardView(SetupWizardController controller, int stepNumber, SetupWizardMode mode) {
