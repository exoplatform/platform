...
List options = new ArrayList();
  ...
  SelectItemCategory office = new SelectItemCategory("OfficePortal");
  office.addSelectItemOption(
      new PortalTemplateConfigOption("", "office", "Office Portal", "OfficePortal").addGroup("/platform/guests")
  );
  options.add(office);
