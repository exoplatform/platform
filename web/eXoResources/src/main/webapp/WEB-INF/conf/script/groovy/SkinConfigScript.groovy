...
SkinService.addSkin("CoreSkin", "Mac", "/eXoResources/skin/webui/component/MacStylesheet.css") ;

SkinService.addSkin("PortalSkin","Mac", "/eXoResources/skin/portal/webui/component/UIPortalApplicationMacSkin.css");
