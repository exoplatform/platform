...
@ComponentConfigs ( {
  @ComponentConfig  (
      ...
      events = {
          @EventConfig(listeners = UIFormInputThemeSelector.SelectThemeActionListener.class, phase = Phase.DECODE),
          @EventConfig(listeners = UIFormInputThemeSelector.SetDefaultActionListener.class, phase = Phase.DECODE)
      }
  ),
  @ComponentConfig(
      ...
      events = {
          @EventConfig(listeners = UIFormInputThemeSelector.ChangeOptionActionListener.class)
      }
...
public class UIFormInputThemeSelector extends UIFormInputBase<String> {
  ...
  public UIFormInputThemeSelector(String name, String bindingField) throws Exception {
    ...
    UIDropDownControl uiCategoryDropDown = addChild(UIDropDownControl.class, "ThemeDropDown", null) ;
  }
  ...
  public static class SelectThemeActionListener extends EventListener<UIFormInputThemeSelector> {

    public void execute(Event<UIFormInputThemeSelector> event) throws Exception {
      UIFormInputThemeSelector uiFormInput = event.getSource() ;
  ...
  public static class ChangeOptionActionListener extends EventListener<UIDropDownControl> {
    ...
    public void execute(Event<UIDropDownControl> event) throws Exception {
      ...
      UIFormInputThemeSelector uiFormInput = uiDropDown.getParent() ;
      UIForm uiForm = uiFormInput.getAncestorOfType(UIForm.class) ;
  ...
  public static class SetDefaultActionListener extends EventListener<UIFormInputThemeSelector> {
